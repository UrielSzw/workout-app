...
interface RestTimeBottomSheetProps {
  currentRestTime: number; // in seconds
  onSelectRestTime: (seconds: number) => void;
}

export const RestTimeBottomSheet = forwardRef<
  BottomSheetModal,
  RestTimeBottomSheetProps
          ...
          {quickOptions.map((option) => (
            ...
            >
              <Typography
                ...
                weight="medium"
                style={{
                  color: selectedTime === option.value ? "white" : colors.text,
                }}
              >
                {option.label}
              </Typography>
